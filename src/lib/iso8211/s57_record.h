...
class S57Record : public RefBase
{
public:
	enum RecordType {
		DDR, 
...
class S57DataDescripRecord : public S57Record
{
private:
...
class S57DSInfoRecord : public S57Record
{
private:
	S57_DSID *_dsid;
	S57_DSSI *_dssi;
...
class S57DSGeoRecord : public S57Record
{
private:
	S57_DSPM *_dspm;
	S57_DSPR *_dspr;
...
class S57DSHistoryRecord : public S57Record
{
private:
	S57_DSHT *_dsht;
...
class S57DSAccuracyRecord : public S57Record
{
private:
	S57_DSAC *_dsac;
...
class S57CatalogDirRecord : public S57Record
{
private:
	S57_CATD *_catd;
...
class S57FeatureRecord : public S57Record
{
private:
	S57_FRID *_frid;
	S57_LNAM *_foid;
...
class S57VectorRecord : public S57Record
{
public:
	enum CoordType { SG2D, SG3D };
