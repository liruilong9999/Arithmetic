...
LogCatItem::LogCatItem(char *p, unsigned long sn, int type, const LString &tag, int flags, const LString &str)
	: _p(p)
{
	assert(str != NULL);
...
char *LogCat::addItem(LogCat::LogType type, const LString &tag, int flags, const LString &str)
{
	wrlock();
...
void LogCat::i(const LString &tag, const LString &str)
{
	addItem(LogCat::Information, tag, 0, str);
}

void LogCat::d(const LString &tag, const LString &str)
{
	addItem(LogCat::Debug, tag, 0, str);
}

void LogCat::w(const LString &tag, const LString &str)
{
	addItem(LogCat::Warning, tag, 0, str);
}

void LogCat::e(const LString &tag, const LString &str)
{
